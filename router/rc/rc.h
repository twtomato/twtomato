...
extern int start_l2tp(int mode);
...
#if 0	// hbobs
// heartbeat.c
extern int start_heartbeat(int mode);
...
extern void start_hbidle(void);
extern void stop_hbidle(void);
extern int hb_idle_main(int argc, char *argv[]);
#endif

// services.c
extern void start_cron(void);
extern void stop_cron(void);
extern void test_cron(void);
