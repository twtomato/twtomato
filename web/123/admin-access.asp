...
createFieldTable('', [
	...
	{ title: '風格', name: 'web_css', type: 'select',
		options: [['red','蕃茄紅'],['black','黑色'],['blue','藍色'],['bluegreen','藍色 &amp; 綠色 (較淺)'],['bluegreen2','藍色 &amp; 綠色 (較深)'],['brown','棕色'],['cyan','青綠色'],['olive','橄欖色'],['pumpkin','南瓜色'],['ext/custom','自定 (ext/custom.css)']], value: nvram.web_css },
