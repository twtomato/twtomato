...
createFieldTable('', [
	...
	{ title: '風格', name: 'web_css', type: 'select',
		options: [['red','蕃茄紅'],['asus','華碩'],['black','黑色'],['blue','藍色'],['bluedream','夢幻藍'],['bluegreen','藍色 &amp; 綠色 (較淺)'],['bluegreen2','藍色 &amp; 綠色 (較深)'],['buffalo','Buffalo'],['cyan','青綠色'],['enlightened','Enlightened'],['linksys','Linksys'],['olive','橄欖色'],['juanantofb','JuanAntoFB'],['pumpkin','南瓜色'],['purple','Purple'],['tijuana','Tijuana'],['ext/custom','Custom (ext/custom.css)']], value: nvram.web_css },
