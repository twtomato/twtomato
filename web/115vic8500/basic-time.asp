...
createFieldTable('', [
	...
	{ title: '時區', name: 'tm_sel', type: 'select', options: [
		...
		['GMT0BST,M3.5.0/2,M10.5.0/2','UTC+00:00 England, Portugal'],
		['UTC-1','UTC+01:00 突尼西亞'],
		['STD-1DST,M3.5.0/2,M10.5.0/2','UTC+01:00 Belgium, France, Germany, Italy, Spain, Sweden'],
		['UTC-2','UTC+02:00 南非'],
	...
	{ title: '日光節約時間(夏令)', indent: 2, name: 'f_tm_dst', type: 'checkbox', value: nvram.tm_dst != '0' },
	{ title: '自訂 時區 字串', indent: 2, name: 'f_tm_tz', type: 'text', maxlen: 32, size: 34, value: nvram.tm_tz || '' },
	null,
	{ title: '時間同步', name: 'ntp_updates', type: 'select', options: [[-1,'不同步'],[0,'啟動時更新'],[1,'１小時'],[2,'２小時'],[4,'４小時'],[6,'６小時'],[8,'８小時'],[12,'１２小時'],[24,'每天一次']],
