...
createFieldTable('', [
	...
	{ title: '事件日誌紀錄' },
		{ title: '瀏覽網路(限制/允許)', indent: 2, name: 'f_log_acre', type: 'checkbox', value: (nvram.log_events.indexOf('acre') != -1) },
	...
	{ title: '連接日誌紀錄' },
		{ title: '對內連線', indent: 2, name: 'log_in', type: 'select', options: [[0,'關閉 (建議)'],[1,'被防火牆拒絕'],[2,'被防火牆允許'],[3,'拒絕與允許都記錄']], value: nvram.log_in },
		{ title: '對外連線', indent: 2, name: 'log_out', type: 'select', options: [[0,'關閉 (建議)'],[1,'被防火牆拒絕'],[2,'被防火牆允許'],[3,'拒絕與允許都記錄']], value: nvram.log_out },
