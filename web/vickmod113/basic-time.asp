...
<div class='section-title'>系統時間同步</div>
<div class='section'>
<script type='text/javascript'>
...
createFieldTable('', [
	...
	{ title: '時區', name: 'tm_sel', type: 'select', options: [
		...
		['EET-2EEST-3,M3.5.0/3,M10.5.0/4','UTC+03:00 Finland'],
		...
		['CST-9:30CST,M10.5.0/2,M4.1.0/3', 'UTC+09:30 South Australia'],
	...
	{ title: '夏令時間', indent: 2, name: 'f_tm_dst', type: 'checkbox', value: nvram.tm_dst != '0' },
	{ title: 'Custom TZ String', indent: 2, name: 'f_tm_tz', type: 'text', maxlen: 32, size: 34, value: nvram.tm_tz || '' },
	null,
	{ title: '時間同步', name: 'ntp_updates', type: 'select', options: [[-1,'不同步'],[0,'每次啟動'],[1,'每小時'],[2,'每兩小時'],[4,'每四小時'],[6,'每六小時'],[8,'每八小時'],[12,'半天一次'],[24,'每天一次']],
