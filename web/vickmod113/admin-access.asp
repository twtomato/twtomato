...
<div class='section-title'>遠端登入</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
	{ title: '協定', name: 'f_http_local', type: 'select', options: [[0,'Disabled'],[1,'HTTP'],[2,'HTTPS'],[3,'HTTP &amp; HTTPS']],
	...
	{ title: '無線網路-登入管理', name: 'f_http_wireless', type: 'checkbox', value:  nvram.web_wl_filter == 0 },
	null,
	{ title: '風格', name: 'web_css', type: 'select',
		options: [['red','Tomato'],['black','Black'],['blue','Blue'],['bluegreen','Blue &amp; Green (Lighter)'],['bluegreen2','Blue &amp; Green (Darker)'],['cyan','Cyan'],['olive','Olive'],['pumpkin','Pumpkin'],['purple','Purple'],['ext/custom','Custom (ext/custom.css)']], value: nvram.web_css },
...
createFieldTable('', [
	...
	{ title: '密碼登入', name: 'f_sshd_pass', type: 'checkbox', value: nvram.sshd_pass == 1 },
...
<div class='section-title'>密碼</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
