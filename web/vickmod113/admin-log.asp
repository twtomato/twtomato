...
<title>[<% ident(); %>] 路由器管理設定：Logging</title>
...
<script type='text/javascript'>
createFieldTable('', [
	{ title: '機器記錄檔', name: 'f_log_file', type: 'checkbox', value: nvram.log_file == 1 },
	{ title: '紀錄至遠端系統', name: 'f_log_remote', type: 'checkbox', value: nvram.log_remote == 1 },
	...
	{ title: 'Connection Logging' },
		{ title: '對內連線', indent: 2, name: 'log_in', type: 'select', options: [[0,'關閉 (recommended)'],[1,'If Blocked By Firewall'],[2,'If Allowed By Firewall'],[3,'Both']], value: nvram.log_in },
		{ title: '對外連線', indent: 2, name: 'log_out', type: 'select', options: [[0,'關閉 (recommended)'],[1,'If Blocked By Firewall'],[2,'If Allowed By Firewall'],[3,'Both']], value: nvram.log_out },
