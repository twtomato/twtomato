...
var svgReady = 0;
var abc = ['未分級', '最高等', '高等級', '中等級', '低等級', '最低', 'Ａ等級', 'Ｂ等級', 'Ｃ等級', 'Ｄ等級', 'Ｅ等級'];
var colors = [
	'c6e2ff',
	'b0c4de',
	'9ACD32',
...
for (i = 0; i < 11; ++i) {
	...
	<tr><td>&nbsp;</td><td class="total">總和</a></td><td id="ccnt-total" class="total count"></td><td class="total pct">100%</td></tr>
	</table>
...
for (i = 1; i < 11; ++i) {
	...
	<tr><td>&nbsp;</td><td class="total">總和</a></td><td id="bcnt-total" class="total count"></td><td class="total pct">100%</td></tr>
	</table>
</td><td style="margin-right:150px">
<script type='text/javascript'>
if (nvram.web_svg != '0') {
