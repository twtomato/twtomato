...
createFieldTable('', [
	...
	{ title: '星期幾', indent: 2, multi: [
		{ name: 'f_sched_sun', type: 'checkbox', suffix: ' 日 &nbsp; ', value: (rule[4] & 1) },
		{ name: 'f_sched_mon', type: 'checkbox', suffix: ' 一 &nbsp; ', value: (rule[4] & (1 << 1)) },
		{ name: 'f_sched_tue', type: 'checkbox', suffix: ' 二 &nbsp; ', value: (rule[4] & (1 << 2)) },
		{ name: 'f_sched_wed', type: 'checkbox', suffix: ' 三 &nbsp; ', value: (rule[4] & (1 << 3)) },
		{ name: 'f_sched_thu', type: 'checkbox', suffix: ' 四 &nbsp; ', value: (rule[4] & (1 << 4)) },
		{ name: 'f_sched_fri', type: 'checkbox', suffix: ' 五 &nbsp; ', value: (rule[4] & (1 << 5)) },
		{ name: 'f_sched_sat', type: 'checkbox', suffix: ' 六', value: (rule[4] & (1 << 6)) } ] },
	{ title: '型式', name: 'f_type', type: 'select', options: [[0,'一般限制'],[1,'關閉無線']], value: (rule[5] == '~') ? 1 : 0 },
	...
	{ title: '限制', name: 'f_block_all', type: 'checkbox', suffix: ' 限制所有的網際網路連線', value: 0 },
