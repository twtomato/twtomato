...
createFieldTable('', [
	{ title: 'WAN 的 MAC', indent: 1, name: 'f_mac_wan', type: 'text', maxlen: 17, size: 20,
		suffix: ' <input type="button" value="預設值" onclick="bdefault(\'wan\')"> <input type="button" value="亂數產生" onclick="brand(\'wan\')"> <input type="button" value="複製 PC 的MAC" onclick="bclone(\'wan\')">',
		value: nvram.mac_wan || defmac.wan },
	{ title: 'Wireless 的 MAC', indent: 1, name: 'f_mac_wl', type: 'text', maxlen: 17, size: 20,
		suffix:' <input type="button" value="預設值" onclick="bdefault(\'wl\')"> <input type="button" value="亂數產生" onclick="brand(\'wl\')"> <input type="button" value="複製 PC 的MAC" onclick="bclone(\'wl\')">',
		value: nvram.mac_wl || defmac.wl }
]);
</script>
<br>
<table border=0 cellpadding=1>
	<tr><td>路由器的MAC:</td><td><b><% nv('et0macaddr'); %></b></td></tr>
	<tr><td>PC網卡的MAC:</td><td><b><% compmac(); %></b><tr><td>
</table>
</div>
