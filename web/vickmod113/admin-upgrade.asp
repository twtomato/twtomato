...
<div id='afu-input'>
	...
	<div class='section'>
		...
		<div id='box-input'>
			選擇韌體:<br>
			<input type='file' name='file' size='50' style='height:20px'> <input type='button' value='韌體更新' id='afu-upgrade-button' onclick='upgrade()' style='height:20px'>
		</div>
		</form>

		<br>
		<table border=0>
		<tr><td>目前韌體版本:</td><td>&nbsp; <% version(1); %></td></tr>
		<script type='text/javascript'>
		//	<% sysinfo(); %>
		W('<tr><td>記憶體剩餘:</td><td>&nbsp; ' + scaleSize(sysinfo.totalfreeram) + ' &nbsp; <small>(剩餘記憶體盡量大於韌體檔案)</small></td></tr>');
		</script>
		</table>
...
更新前請先備份 JFFS2 的資料. 關閉JFFS2 並重開ROUTER.<br><br><br>
