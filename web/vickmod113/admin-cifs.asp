...
createFieldTable('', [
	...
	{ title: 'Total / Free Size', indent: 2, text: cifs1.size ? (scaleSize(cifs1.size) + ' / ' + scaleSize(cifs1.free)) : '(未掛載)' },
	null,
	{ title: '/cifs2' },
	...
	{ title: 'Total / Free Size', indent: 2, text: cifs2.size ? (scaleSize(cifs2.size) + ' / ' + scaleSize(cifs2.free)) : '(未掛載)' }
]);
</script>
</div>
