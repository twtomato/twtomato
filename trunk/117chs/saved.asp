...
if (wait <= 0) s = '<b>已保存设置...</b> &nbsp; <input type="button" value="继续" onclick="go()" style="font:10px sans-serif;vertical-align:top">';
	else s = '<b>请稍后...</b><span id="xclock" style="font-size:9px;background:#f7f7f7;padding:1px;visibility:hidden">&nbsp;</span> <img src="spin.gif" id="spin" onload="setSpin(1)">';
document.write(s);
</script>
</form>
</td></tr>
