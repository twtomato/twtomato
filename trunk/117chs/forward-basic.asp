...
fog.setup = function() {
	this.init('fo-grid', 'sort', 50, [
		...
		{ type: 'text', maxlen: 15 },
		{ type: 'text', maxlen: 32 }]);
	this.headerSet(['启用', '协议', '源地址', '外部端口', '内部端口', '内部地址', '叙述']);
...
<div class='section-title'>端口转发</div>
<div class='section'>
...
<li><b>外部端口</b> - 从WAN对应进来的端口. 例: "2345", "200,300", "200-300,400".
<li><b>内部端口</b> <i>(可选)</i> -  .若为空, 便自动对应 <i>外部端口</i>.
当内部端口与外部端口范围不同时,才须填入内部端口.

<li><b>内部地址</b> - 对应局域网络内的IP地址.
</ul>
</div>
