...
<div class='section'>
	<input type='radio' name='f_type' id='_f_disable' value='disabled'> 禁止使用过滤器<br>
	<input type='radio' name='f_type' id='_f_allow' value='allow'> 允许如下客户端<br>
	<input type='radio' name='f_type' id='_f_deny' value='deny'> 阻止如下客户端<br>
	<br>
