...
//	<% nvram("sesx_led,sesx_b0,sesx_b1,sesx_b2,sesx_b3,sesx_script,script_brau,sex_b4,sesx_script_1,sesx_script_2,t_model,t_features"); %>
...
<div class='section'>
<script type='text/javascript'>
a = [[0,'不做任何事'],[1,'開/關 無線網路'],[2,'重開機'],[3,'關機'],[4,'執行自訂 Script'],[5, '執行自訂 Script 1'],[6, '執行自訂 Script 2']];
createFieldTable('', [
{ title: "按AOSS鈕的時間啟動..." },
	...
	{ title: '12-14 秒', indent: 2, name: 'sesx_b3', type: 'select', options: a, value: nvram.sesx_b3 || 0 },
	{ title: '16+ 秒', indent: 2, name: 'sesx_b4', type: 'select', options: a, value: nvram.sesx_b4 || 0 },
	{ title: '自訂 Script', indent: 2, name: 'sesx_script', type: 'textarea', value: nvram.sesx_script },
	{ title: '自訂 Script 1', indent: 2, name: 'sesx_script_1', type: 'textarea', value: nvram.sesx_script_1 },
	{ title: '自訂 Script 2', indent: 2, name: 'sesx_script_2', type: 'textarea', value: nvram.sesx_script_2 }
]);
</script>
</div>
</div>
