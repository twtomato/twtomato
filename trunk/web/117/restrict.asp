...
og.setup = function() {
	...
	this.headerSet(['註解', '排程']);
	var r = this.footerSet(['<input type="button" value="新增" onclick="TGO(this).addEntry()" id="res-over-add">']);
	r.cells[0].colSpan = 2;
}
...
<div class='section-title'>存取控制清單</div>
<div class='section'>
