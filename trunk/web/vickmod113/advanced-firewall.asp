...
<script type='text/javascript'>
createFieldTable('', [
	{ title: '回應從網際網路的PING', name: 'f_icmp', type: 'checkbox', value: nvram.block_wan == '0' },
	{ title: '允許群體廣播', name: 'f_multicast', type: 'checkbox', value: nvram.multicast_pass == '1' },
	{ title: 'NAT Loopback', name: 'nf_loopback', type: 'select', options: [[0,'Enabled'],[1,'Forwarded Only'],[2,'Disabled']], value: fixInt(nvram.nf_loopback, 0, 2, 0) }
]);
</script>
</div>
