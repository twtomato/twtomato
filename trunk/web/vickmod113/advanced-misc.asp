...
<div class='section-title'>其他設定</div>
<div class='section'>
<script type='text/javascript'>
a = [];
...
createFieldTable('', [
	...
	{ title: 'WAN連線速度 *', name: 'wan_speed', type: 'select', options: [[0,'10Mb Full'],[1,'10Mb Half'],[2,'100Mb Full'],[3,'100Mb Half'],[4,'自動選擇']], value: nvram.wan_speed }
]);
</script>
<br>
<small>* 非所有機型支援此功能.</small>
</div>
