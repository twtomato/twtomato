...
createFieldTable('', [
	...
	{ title: '帳號', name: 'ppp_username', type: 'text', maxlen: 50, size: 54, value: nvram.ppp_username },
	...
	{ title: '閒置時間', indent: 2, name: 'ppp_idletime', type: 'text', maxlen: 5, size: 7, suffix: ' <i>(minutes)</i>',
		value: nvram.ppp_idletime },
	{ title: '重連時間', indent: 2, name: 'ppp_redialperiod', type: 'text', maxlen: 5, size: 7, suffix: ' <i>(seconds)</i>',
...
createFieldTable('', [
	...
	{ title: '租約時間', indent: 2, name: 'dhcp_lease', type: 'text', maxlen: 6, size: 8, suffix: ' <i>(minutes)</i>',
...
f = [
	...
	{ title: '公用金鑰', indent: 2, name: 'wl_wpa_psk', type: 'text', maxlen: 64, size: 66,
		suffix: ' <input type="button" id="_f_psk_random1" value="亂數產生" onclick="random_psk(\'_wl_wpa_psk\')">',
		value: nvram.wl_wpa_psk },
	{ title: '公用金鑰', indent: 2, name: 'wl_radius_key', type: 'text', maxlen: 80, size: 32,
		suffix: ' <input type="button" id="_f_psk_random2" value="亂數產生" onclick="random_psk(\'_wl_radius_key\')">',
		value: nvram.wl_radius_key },
	{ title: '金鑰轉動間隔', indent: 2, name: 'wl_wpa_gtk_rekey', type: 'text', maxlen: 4, size: 6, suffix: ' <i>(seconds)</i>',
	...
	{ title: 'WEP加密', indent: 2, name: 'wl_wep_bit', type: 'select', options: [['128','128-bits'],['64','64-bits']],
		value: nvram.wl_wep_bit },
	{ title: '通行碼', indent: 2, name: 'wl_passphrase', type: 'text', maxlen: 16, size: 20,
		suffix: ' <input type="button" id="_f_wep_gen" value="產生" onclick="generate_wep()"> <input type="button" id="_f_wep_random" value="亂數產生" onclick="random_wep()">',
