...
<div class='section-title'>回存設定檔</div>
<div class='section'>
...
<div class='section-title'>恢復出廠設定值</div>
<div class='section'>
	<form id='aco-reset-form' method='post' action='defaults.cgi'>
	<select name='mode' id='restore-mode'>
		<option value=0>請選擇...</option>
		<option value=1>恢復TOMATO預設值 (normal)</option>
		<option value=2>清除NVRAM所有資料 (thorough)</option>
	</select>
	<input type='button' value='確認' onclick='resetButton()' id='reset-button'>
	</form>
</div>
