...
function v_wep(e, quiet)
{
	...
	if (s.length != e.maxLength) {
		ferror.set(e, '錯誤的 WEP key, ', quiet);
		return 0;
	}
	e.value = s;
	ferror.clear(e);
...
<div class='section-title'>廣域網路(WAN)設定</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
	{ text: '<span id="_wan_na"><i>無線網路橋接模式</i></span>' },
	{ title: '連線類型', name: 'wan_proto', type: 'select', options: [['dhcp','DHCP'],['pppoe','PPPoE 撥接'],['static','固定 IP'],['pptp','PPTP'],['l2tp','L2TP'],['disabled','關閉']],
...
<div class='section-title'>區域網路(LAN)設定</div>
<div class='section'>
<script type='text/javascript'>
...
<script type='text/javascript'>
f = [
	{ title: '開啟無線上網', name: 'f_wl_radio', type: 'checkbox',
	...
	{ title: '頻道', name: 'wl_channel', type: 'select', options: ghz, suffix: ' <input type="button" id="_f_scan" value="掃瞄" onclick="scanButton()"> <img src="spin.gif" id="spin">',
