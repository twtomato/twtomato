...
//<% nvram("l2tp_get_ip,pptp_get_ip,pptp_server_ip,router_name,clkfreq,wan_domain,wan_gateway,wan_get_domain,wan_hostname,wan_hwaddr,wan_ipaddr,wan_ipaddr_buf,wan_netmask,wan_proto,wan_run_mtu,et0macaddr,lan_proto,lan_ipaddr,dhcp_start,dhcp_num,lan_netmask,security_mode2,wl_crypto,wl_mode,wds_enable,wl0_hwaddr,wl_net_mode,wl_radio,wl_channel,lan_gateway,wl_ssid,t_model_name"); %>
//<% uptime(); %>
//<% sysinfo(); %>
//<% wlradio(); %>
...
do {
	...
	if ((i >= 1) && (i <= 14)) {
		...
		if (a < 0) stats.channel += ' <small>(¥¿¦b·j´M...)</small>';
	}
	else if (i == 0) {
		stats.channel = 'Auto';
	}
