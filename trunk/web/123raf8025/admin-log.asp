...
createFieldTable('', [
	...
	{ title: '間隔標籤', name: 'log_mark', type: 'select', options: [[0,'Disabled'],[30,'Every 30 Minutes'],[60,'Every 1 Hour'],[120,'Every 2 Hours']], value: nvram.log_mark },
	{ title: '事件日誌記錄', text: '<small>(某些需重新啟動才會生效)</small>' },
