...
tg.setup = function() {
	this.init('ttr-grid');
	this.headerSet(['跃点', '位址', '最小 (ms)', '最大 (ms)', '平均 (ms)', '＋/－ (ms)']);
}
...
<script type='text/javascript'>
createFieldTable('', [
	{ title: '地址', name: 'f_addr', type: 'text', maxlen: 64, size: 32, value: '', suffix: ' <input type="button" value="开始追踪" onclick="trace()" id="traceb">' },
...
<div style='visibility:hidden;text-align:right' id='wait'>请稍后... <img src='spin.gif' style='vertical-align:top'></div>
