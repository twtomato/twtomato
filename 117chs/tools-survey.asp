...
sg.setup = function() {
	...
	this.headerSet(['最近可见', '服务标识', '基本服务标识', '信号强度 &nbsp; &nbsp; ', '噪声强度 &nbsp; &nbsp; ', '信号质量', '所选信道', '适应能力', '传输速率']);
	this.populate();
	this.sort(0);
}
...
<div class='section-title'>无线网路勘查</div>
<div class='section'>
	...
	<div id='survey-controls'>
		...
		genStdTimeList('refresh-time', '自动更新', 0);
		</script>
