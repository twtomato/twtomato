...
<script type='text/javascript'>
createFieldTable('', [
	{ title: '最大连接数', name: 'ct_max', type: 'text', maxlen: 5, size: 7,
		...
		value: fixInt(nvram.ct_max || 20480, 128, 65535, 20480) }
]);
</script>
<br>
...
<div class='section-title'>UDP 超时设置</div>
<div class='section'>
<script type='text/javascript'>
...
createFieldTable('', [
	{ title: 'TTL 调整', name: 'nf_ttl', type: 'select', options: v, value: nvram.nf_ttl },
	{ title: '下行启用 应用层过滤', name: 'f_l7in', type: 'checkbox', value: nvram.nf_l7in != '0' }
]);
</script>
</div>
