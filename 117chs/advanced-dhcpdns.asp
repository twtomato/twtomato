...
<div class='section-title'>DHCP / DNS 服务器</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
	{ title: '开启内置 DNS 快取转发', name: 'f_dhcpd_dmdns', type: 'checkbox', value: nvram.dhcpd_dmdns == '1' },
	{ title: '使用静态 DNS 服务器', name: 'f_dns_addget', type: 'checkbox', value: nvram.dns_addget == '1' },
	{ title: '截获 DNS 端口(UDP 53)', name: 'f_dns_intcpt', type: 'checkbox', value: nvram.dns_intcpt == '1' },
	{ title: '静态租约时间', multi: [
...
<script type='text/javascript'>
createFieldTable('', [
	{ title: '压缩包', name: 'f_dhcpc_minpkt', type: 'checkbox', value: nvram.dhcpc_minpkt == '1' }
]);
</script>
</div>
