...
<div class='section-title'>DMZ设置</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
	...
	{ title: '源地址限制<br>范围', indent: 2, name: 'dmz_sip', type: 'text', maxlen: 32, size: 32,
		value: nvram.dmz_sip, suffix: '&nbsp;<small>("空白" 不限制,可单一IP或范围;例: "1.1.1.1", "1.1.1.0/24" 或 "1.1.1.1 - 2.2.2.2")</small>' }
]);
</script>
</div>
