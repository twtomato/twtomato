...
ara.setup = function() {
	...
	this.headerSet(['目的端', '网关', '子网掩码', 'Metric', '网络接口']);
...
ars.setup = function() {
	...
	this.headerSet(['目的端', '网关', '子网掩码', 'Metric', '网络接口', '描述']);
...
createFieldTable('', [
	...
	{ title: 'RIPv1 &amp; v2', name: 'dr_setting', type: 'select',	options: [[0,'禁用'],[1,'LAN'],[2,'WAN'],[3,'两者']], value:	nvram.dr_setting },
	{ title: 'Spanning-Tree 协议', name: 'f_stp', type: 'checkbox', value: nvram.lan_stp != '0' },
]);
</script>
</div>
