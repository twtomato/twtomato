...
createFieldTable('', [
	...
	{ title: '时区', name: 'tm_sel', type: 'select', options: [
		...
		['STD-1DST,M3.5.0/2,M10.5.0/2','UTC+01:00 法国,德国,义大利,瑞典'],
		['UTC-2','UTC+02:00 南非'],
		['STD-2DST,M3.5.0/2,M10.5.0/2','UTC+02:00 希腊,乌克兰,罗马尼亚,土耳其'],
		['UTC-3','UTC+03:00 伊拉克,约旦,科威特'],
		['EET-2EEST-3,M3.5.0/3,M10.5.0/4','UTC+03:00 芬兰'],
		['UTC-4','UTC+04:00 亚美尼亚'],
		['UTC-5','UTC+05:00 巴基斯坦, 俄罗斯'],
		['UTC-5:30','UTC+05:30 孟买,加尔各答,千奈,新德里'],
		['UTC-6','UTC+06:00 孟加拉,俄国'],
		['UTC-7','UTC+07:00 泰国, 俄罗斯'],
	...
	null,
	{ title: '自动时间同步', name: 'ntp_updates', type: 'select', options: [[-1,'不同步'],[0,'启动时更新'],[1,'每小时'],[2,'每两小时'],[4,'每四小时'],[6,'每六小时'],[8,'每八小时'],[12,'半天一次'],[24,'每天一次']],
		value: nvram.ntp_updates },
	{ title: '需要时同步', indent: 2, name: 'f_ntp_tdod', type: 'checkbox', value: nvram.ntp_tdod != '0' },
	{ title: 'NTP 网络时间服务器', name: 'f_ntp_server', type: 'select', options: ntpList, value: ntpSel },
