...
<div class="section-title">带宽分布图表 (上传)</div>
<div class="section">
<table border=0 width="100%"><tr><td>
	<table style="width:250px">
<script type='text/javascript'>
for (i = 1; i < 11; ++i) {
	...
	<tr><td>&nbsp;</td><td class="total">合计</a></td><td id="bcnt-total" class="total count"></td><td class="total pct">100%</td></tr>
	</table>
</td><td style="margin-right:150px">
<script type='text/javascript'>
if (nvram.web_svg != '0') {
...
if (nvram.qos_enable != '1') {
	W('<div class="note-disabled"><b>QoS 未启用.</b> &nbsp; <a href="qos-settings.asp">启用 &raquo;</a></div>');
}
</script>
