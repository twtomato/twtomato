...
<title>[<% ident(); %>] 系统管理：按钮功能 / LED</title>
...
<div class='section-title'>SES/AOSS 按钮设置</div>
<div class='section'>
<script type='text/javascript'>
a = [[0,'不做任何事'],[1,'开/关 无线网络'],[2,'重启系统'],[3,'关闭系统'],[4,'运行脚本']];
createFieldTable('', [
	{ title: "当按下时..." },
...
<div class='section-title'>桥接开关</div>
<div class='section'>
<script type='text/javascript'>
createFieldTable('', [
