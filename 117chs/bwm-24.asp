...
<div id='rstats'>
	...
	<div id='bwm-controls'>
		...
		绘图:&nbsp;
			<a href='javascript:switchDraw(0)' id='draw0'>填满</a>,
		...
		<br><br>
		&nbsp; &raquo; <a href="admin-bwm.asp">设定</a>
	</div>
...
if (nvram.rstats_enable != '1') {
	W('<div class="note-disabled">带宽监控已关闭.</b><br><br><a href="admin-bwm.asp">开启 &raquo;</a><div>');
	E('rstats').style.display = 'none';
}
else {
	W('<div class="note-warning" style="display:none" id="rbusy">程序繁忙或没有响应. 请稍候再试.</div>');
}
</script>
