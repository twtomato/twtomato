...
<title>[<% ident(); %>] 路由器管理設定 : SD/MMC</title>
...
createFieldTable('', [
	{ title: '啟用', name: 'f_mmc_on', type: 'checkbox', value: mmcon },
	{ title: '檔案系統', name: 'f_mmc_fs_type', type: 'select', options: [['ext2','ext2'],['ext3','ext3'],['vfat','vfat']], value: nvram.mmc_fs_type },
	{ title: '磁碟分割', name: 'f_mmc_fs_partition', type: 'select', options: [[1,1],[2,2],[3,3],[4,4]], value: nvram.mmc_fs_type },
	null,
	{ title: '掛載後執行', name: 'f_mmc_exec_mount', type: 'text', maxlen: 64, size: 34, value: nvram.mmc_exec_mount },
	{ title: '卸載前執行', name: 'f_mmc_exec_umount', type: 'text', maxlen: 64, size: 34, value: nvram.mmc_exec_umount },
	null,
