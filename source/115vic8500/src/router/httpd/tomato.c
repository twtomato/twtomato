...
// basic-static
	{ "dhcpd_static",		V_LENGTH(0, 53*50)	},	// 53 (max chars per entry) x 50 entries

// basic-ddns
	{ "ddnsx0",				V_LENGTH(0, 512)	},
	{ "ddnsx1",				V_LENGTH(0, 512)	},
...
// basic-wfilter
	...
	{ "wl_maclist",			V_LENGTH(0, 1800)	},	// 18 x 100		(11:22:33:44:55:66 ...)
	{ "macnames",			V_LENGTH(0, 3100)	},	// 62 (12+1+48+1) x 50	(112233445566<..>)		todo: re-use -- zzz
...
// srv-samba
	{ "smbd_on",			V_01				},
	{ "nmbd_on",			V_01				},
	{ "smbd_wgroup",		V_LENGTH(3, 32)		},
	{ "smbd_nbname",		V_LENGTH(3, 32)		},
	{ "smbd_adminpass",		V_LENGTH(3, 32)		},
#endif
...
// admin-mmc
  	{ "mmc_on",			V_01				}, 
  	{ "mmc_fs_type",		V_LENGTH(4, 4)			},
  	{ "mmc_fs_partition",		V_01				},
  	{ "mmc_exec_mount",		V_LENGTH(0, 64)			},
  	{ "mmc_exec_umount",		V_LENGTH(0, 64)			}, 

//	qos
	{ "qos_enable",			V_01				},
	{ "qos_method",			V_RANGE(0, 1)		},	// 0,1
	{ "qos_ack",			V_01				},
	{ "qos_icmp",			V_01				},
	{ "qos_reset",			V_01				},
